...
agent.configure(with: "You are an assistant that is good at organizing technical highlights.")

Task {
    do {
        let response = try await agent.chat(to: "Please explain the purpose of LanguageModelSession")
